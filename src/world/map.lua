...
local function addTiledObjectsToMap(map)
    ...
    for _, obj in ipairs(TiledMap.getObjects(tiled, "npcs")) do
        ...
        table.insert(map.npcs, {
            x = x,
            y = y,
            radius = objectProperty(obj, "radius", 11) or 11,
            speed = objectProperty(obj, "speed", 72) or 72,
            spriteSet = objectProperty(obj, "spriteSet", ((npcIndex - 1) % 2) + 4),
            spriteFacing = objectProperty(obj, "spriteFacing", "down"),
        ...
        if Map.dungeonTileset and love.filesystem.getInfo(Map.dungeonTileset.imagePath) then
            ...
            if runtimeTileset then
                ...
                caveTileTheme = {
                    ...
                    walls = {
                        outerTopLeft = localToGid(firstWallId(wallPalette.outerTopLeft, wallPalette.topLeft),
                            unwalkableFloorGid),
                        top = localToGid(firstWallId(wallPalette.top), unwalkableFloorGid),
                        outerTopRight = localToGid(firstWallId(wallPalette.outerTopRight, wallPalette.topRight),
                            unwalkableFloorGid),
                        ...
                        topCapLeft = localToGid(firstWallId(wallPalette.topCapLeft, wallPalette.topCap, wallPalette.top),
                            unwalkableFloorGid),
                        topCap = localToGid(firstWallId(wallPalette.topCap, wallPalette.top), unwalkableFloorGid),
                        topCapRight = localToGid(
                            firstWallId(wallPalette.topCapRight, wallPalette.topCap, wallPalette.top), unwalkableFloorGid),
                        ...
                        outerBottomLeft = localToGid(firstWallId(wallPalette.outerBottomLeft, wallPalette.bottomLeft),
                            unwalkableFloorGid),
                        bottom = localToGid(firstWallId(wallPalette.bottom), unwalkableFloorGid),
                        outerBottomRight = localToGid(firstWallId(wallPalette.outerBottomRight, wallPalette.bottomRight),
                            unwalkableFloorGid),
                        ...
                        innerBottomRight = localToGid(
                            firstWallId(wallPalette.innerBottomRight, wallPalette.outerBottomRight,
                                wallPalette.bottomRight),
                            unwalkableFloorGid
                        ),
                    },
                }
